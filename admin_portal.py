...
def system_stats():
    ...
    from models import User, Item, Sale, Customer, Category, FinancialTransaction, db, Location
...
def delete_user(user_id):
    ...
    try:
        ...
        flash(f'User {email} has been successfully deleted.', 'success')
...
def manage_user_permissions(user_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            flash(f'Permissions for {user.email} have been updated.', 'success')
...
def dashboard_data():
    ...
    from models import Sale, User, db
